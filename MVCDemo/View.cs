...
static class View
{
    ...
    public static string Input(string prompt="")
    {
        ...
        String? input = Console.ReadLine(); // to prevent annoying possible null reference return warning.
        Console.WriteLine();
    ...
    public static void DisplayUnknownInput(string inputToken) => Console.WriteLine($"'{inputToken}' is not defined. Please type a command.");
